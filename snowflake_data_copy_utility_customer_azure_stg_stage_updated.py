...
CUSTOMER_AZURE_STAGE_URL = "azure://stgehaedpstg01.blob.core.windows.net/landing/"
...
with source_col:
    ...
    if source_type == "Snowflake Table":
        ...
        st.caption("Azure Blob files are accessed through the configured Snowflake external stage. The file is never downloaded into Streamlit.")
        st.caption(f"Storage integration: `{CUSTOMER_AZURE_STORAGE_INTEGRATION}` | Azure location: `{CUSTOMER_AZURE_STAGE_URL}`")
